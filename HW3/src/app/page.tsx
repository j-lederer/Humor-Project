    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600">
      <main className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-12 shadow-xl">
        <h1 className="text-5xl font-bold text-white drop-shadow-lg mb-4">
          HW3: Protected Routes
        </h1>
        <p className="text-xl text-white/80 mb-8">
          Google OAuth with Supabase Authentication
        </p>
        ...
        {user ? (
          <div className="space-y-6">
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-6 py-3 bg-white text-indigo-600 font-semibold rounded-lg hover:bg-white/90 transition-colors cursor-pointer"
              >
          ...
          <div className="space-y-6">
            <p className="text-white/70">
              Sign in with Google to access protected content
            </p>
            <button
